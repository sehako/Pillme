...
import com.americanstartup.pillme.auth.application.exception.sms.*;
import com.americanstartup.pillme.auth.application.exception.validation.InvalidPhoneNumberException;
import com.americanstartup.pillme.auth.application.exception.verification.ExpiredSmsCodeException;
import com.americanstartup.pillme.auth.application.exception.verification.InvalidSmsCodeException;
...
public class SmsService {
    ...
    public SingleMessageSentResponse sendVerificationSms(String phoneNumber) {
        ...
        message.setText(String.format("[Pillme] 인증번호: %s\n인증번호는 5분간 유효합니다.", verificationCode));
